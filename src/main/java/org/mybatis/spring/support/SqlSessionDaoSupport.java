 ...
 * be used to execute SQL methods. This class needs a SqlSessionTemplate or a SqlSessionFactory. If both are set the SqlSessionFactory will be ignored.
...
public abstract class SqlSessionDaoSupport extends DaoSupport {
   ...
   * SqlSessionFactory reference! Can be overridden in subclasses to provide a SqlSessionTemplate instance with
   * different configuration, or a custom SqlSessionTemplate subclass.
  ...
  /**
   * Return the SqlSessionTemplate for this DAO, pre-initialized with the SessionFactory or set explicitly. <b>Note: The
   * returned SqlSessionTemplate is a shared instance.</b> You may introspect its configuration, but not modify the
   * configuration (other than from within an {@link #initDao} implementation). Consider creating a custom
